...
public class client implements ActionListener {     //ActionListener is used to perform action like back icon
    
    JTextField text;            //Globally Declaring To Perform Action 
    static JPanel a1;    //Globally DEclared To Print The Text Over The Panel
    ...
    client() {
       f.setLayout(null);
        ...
        JLabel name = new JLabel("Person B");                                                               //Name Of Sender(Person A)
    ...
    public static void main(String[] args) {                                                                    //Main Function
        ...
        try {
            Socket s = new Socket("127.0.0.1",6001);  //Important Creating Socket And Connecting To The Server Using Local Host And port Number 
